...
// Returns the private 'App\Repository\BlogUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BlogUserRepository.php';

return $this->privates['App\Repository\BlogUserRepository'] = new \App\Repository\BlogUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
