...
// Returns the private 'App\Repository\BlogCategoriesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BlogCategoriesRepository.php';

return $this->privates['App\Repository\BlogCategoriesRepository'] = new \App\Repository\BlogCategoriesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
