...
// Returns the private 'App\Repository\BlogContentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BlogContentRepository.php';

return $this->privates['App\Repository\BlogContentRepository'] = new \App\Repository\BlogContentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
